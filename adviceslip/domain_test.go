...
// HTTP behaviour is covered in adviceslip_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "adviceslip://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("adviceslip", "about")
	if err != nil || got.String() != "adviceslip://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want adviceslip://page/about", got.String(), err)
	}
}
