...
```
adviceslip <command> [arguments] [flags]
```

Run `adviceslip <command> --help` for the full flag list on any command. This
...
per operation you declare in `adviceslip/domain.go`.
